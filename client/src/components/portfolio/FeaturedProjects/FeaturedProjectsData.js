const FeaturedProjectsData = [
  ...
  {
    id: 6,
    title: "Speedshop Originals",
    category: "Automotive & Lifestyle",
    platform: "Web Development",
    projectType: "E-Commerce & Lifestyle Platform",
    description:
      "A high-octane digital presence and merchandise storefront engineered for Speedshop Originals to showcase automotive culture and custom performance apparel.",
    logo: "/images/portfolio/logos/speedshop-originals.webp",
    logoAlt: "Speedshop Originals Logo",
    website: "https://speedshoporiginals.com/",
    status: "Live",
    technologies: ["Shopify", "Liquid", "JavaScript"],
  },
  {
